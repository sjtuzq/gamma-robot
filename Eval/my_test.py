...
if __name__ == '__main__':
    ...
    def accuracy(output, target, topk=(1,)):
        ...
        my_pred = pred.data.numpy().squeeze()
    ...
    data_loader = torch.utils.data.DataLoader(
            TSNDataSet('/scr1/system/alpha-robot/dataset/cycled_video/cycled_img/cycled_data',
                       '/scr1/system/alpha-robot/dataset/cycled_video/cycled_img/video_list.txt',
    ...
    for i, (data, label) in data_gen:
        ...
        prec1, prec5 = accuracy(torch.from_numpy(np.mean(rst[1], axis=0)), label, topk=(1, 174))
