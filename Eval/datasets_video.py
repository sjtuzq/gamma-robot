...
ROOT_DATASET = '/scr1/workspace/dataset/sth-sth'
...
def return_somethingv2(modality):
    filename_categories = 'captions/somethingv2_categories.txt'
    if modality == 'RGB':
        # root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/v2/20bn-something-something-v2'
        root_data = '/scr1/workspace/dataset/sth-sth/extract_frames'
        # root_data = '/mnt/localssd1/aandonia/something/v2/20bn-something-something-v2-frames'
        filename_imglist_train = '/scr1/workspace/dataset/sth-sth/captions/train_videofolder.txt'
        filename_imglist_val = '/scr1/workspace/dataset/sth-sth/captions/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/flow'
        # root_data = '/mnt/localssd1/bzhou/something/flow'
