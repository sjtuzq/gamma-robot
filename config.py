...
parser.add_argument('--start_train', default=80, type=int) # replay buffer size
...
parser.add_argument('--test_id',  default=1146, type=int) #  1000+ means debug
...
parser.add_argument('--action_id',  default=18, type=int) #
