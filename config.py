...
parser.add_argument('--update_time', default=2, type=int)
...
parser.add_argument('--test_id',  default=63, type=int) #  1000+ means debug
...
parser.add_argument('--rand_box',  default='rand', type=str) # rand or two or others

parser.add_argument('--axis_limit_x',  default='[0.04,0.55]', type=str) #
parser.add_argument('--axis_limit_y',  default='[-0.35,0.25]', type=str) #
parser.add_argument('--axis_limit_z',  default='[0.26,0.55]', type=str) #
...
parser.add_argument('--out_reward',  default=-30, type=float) #
