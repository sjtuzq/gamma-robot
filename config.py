...
parser.add_argument('--test_id',  default=105, type=int) #  1000+ means debug
...
parser.add_argument('--action_id',  default=43, type=int) #
...
parser.add_argument('--add_mask',  default=False, type=int) #
