...
"""
action 112: putting something onto something
"""
...
class Engine112(Engine):
    def __init__(self, opt, worker_id=None):
        super(Engine112,self).__init__(opt)
        self.opt = opt 
        self._wid = worker_id
    ...
    def init_obj(self):
        ...
        self.obj2_id = self.p.loadURDF( os.path.join(self.env_root, "urdf/obj_libs/bottles/b2/b2.urdf"),globalScaling=self.obj2_scaling,useFixedBase=True)
