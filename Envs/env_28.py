...
class Engine28 (Engine):
    def __init__ (self, opt, worker_id=None):
        super (Engine28, self).__init__ (opt)
        self.opt = opt
        self._wid = worker_id
    ...
    def reset_obj (self):
        self.p.resetBasePositionAndOrientation (self.obj_id, [0.3637 + 0.06, -0.05, 0.3515],
                                                [0, 0, -0.1494381, 0.9887711])
