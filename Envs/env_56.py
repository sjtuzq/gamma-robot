...
"""
action 56: poking something so lightly that it doesn’t or almost doesn’t move
"""
...
class Engine56(Engine):
    def __init__(self, opt, worker_id=None):
        super(Engine56,self).__init__(opt)
        self.opt = opt 
        self._wid = worker_id
    ...
    def get_handcraft_reward (self):
        ...
        aabb_dist = sum ([(x) ** 2 for x in zip (obj_center)]) ** 0.5
