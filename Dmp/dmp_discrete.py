...
class DMPs_discrete(DMPs):
  ...
  def gen_goal(self, y_des):
    ...
    y_des np.array: the desired trajectoryy to follow.
    """
    return np.copy(y_des[:,-1])

  def gen_psi(self, x):
    """Generates the activity of the basis functions for a giveen
...
if __name__ == "__main__":
  ...
  for ii, bfs in enumerate(n_bfs):
    ...
    # chhange the scale of the movement
    dmp.goal[0] = 3
    dmp.goal[1] = 2
